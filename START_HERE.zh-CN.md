...
1. 先选一个 `command`，单点任务再选 `skill`
2. 提一个真实业务问题，不要只给抽象方向
...
```text
Run commands/shape-ai-feature.md for this request: 为 PM 团队设计一个 AI copilot，帮他们把访谈记录整理成 insight。先澄清，再拆解，再做 feature 定义。
```
