...
Use a lightweight release rhythm for this repository.

## Weekly

- Review new skill requests
- Review bug reports
- Regenerate catalog if new skills or commands were added
...
5. Merge only after docs and commands are consistent
