...
description: Canonical terms for PM AI Skill Toolkit, PM Operating System, and PM Agent Benchmark.
permalink: /core/category-language/
---
...
The goal is not to invent jargon.
The goal is to make a few sharp terms reusable until they become the default way to describe this category.
...
- prompt dump
- prompt collection
- all-in-one PM prompt repo
- better prompts for PMs
